...
public class icecream extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c25=findViewById(R.id.cb25);
        c26=findViewById(R.id.cb26);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (c26.isChecked())
                    s1 =s1 + " "+c26.getText();
                if (s1.equals(" "))
                    Toast.makeText(icecream.this,"Please Selected Order",Toast.LENGTH_LONG).show();
                else
                {
                    Toast.makeText(icecream.this,"Order in process!!",Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(icecream.this,coutndown.class);
