        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (c17.isChecked())
                    s1 =s1 + " "+c17.getText();
                if (s1.equals(" "))
                    Toast.makeText(coffee.this,"Please Selected Order",Toast.LENGTH_LONG).show();
                else
                {
                    Toast.makeText(coffee.this,"Order in process!!",Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(coffee.this,coutndown.class);
