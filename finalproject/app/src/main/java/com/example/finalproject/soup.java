        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (c15.isChecked())
                    s1 =s1 + " "+c15.getText();
                if (s1.equals(" "))
                    Toast.makeText(soup.this,"Please Selected Order",Toast.LENGTH_LONG).show();
                else
                {
                    Toast.makeText(soup.this,"Order in process!!",Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(soup.this,coutndown.class);
